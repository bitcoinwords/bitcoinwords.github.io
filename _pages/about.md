...
**Crypto Words** is an attempt to archive commentary from the crypto community. For the uninitiated, getting up to speed on the crypto space can be daunting. Content is all over the place and there's not an easy way to digest relavant commentary. That's why we made this quarterly journal. 
