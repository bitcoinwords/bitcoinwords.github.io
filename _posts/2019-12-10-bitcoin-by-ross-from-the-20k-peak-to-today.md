---
title: "Bitcoin by Ross: From the $20k Peak to Today"
permalink: "/bitcoin-by-ross-from-the-20k-peak-to-today"
...
# [Bitcoin by Ross: From the $20k Peak to Today](https://medium.com/@RossUlbricht/bitcoin-by-ross-from-the-20k-peak-to-today-c2f11b26f91c)
### By Ross Ulbricht
### Posted December 10, 2019

By Ross Ulbricht

The closer we get to the present in our analysis, the more uncertainty there is in where current prices fit into the larger Elliot Wave pattern (see [here](https://medium.com/p/6adde19066ad/), [here](https://medium.com/p/7ecda8e92ee5/), [here](https://medium.com/p/4f4e86db7a4/), [here](https://medium.com/p/8fe745374a0/) and [here](https://medium.com/p/9522fc0c67f5/) for context). The question posed in my last post was whether the all-time high of ~$20,000 in late 2017 was the end of intermediate wave (5) and thus primary wave ⑤ and cycle wave I, or whether it was just the end of intermediate wave (3).
...
![](/assets/images/2019/m12/bitcoin-by-ross-from-the-20k-peak-to-today1.png)

*Fig. 1*

Let’s look first at the scenario where the $20,000 peak is at the end of wave (3) (Fig. 1). This means that primary wave ⑤ (one degree higher) is still playing out and we should see prices move to new all-time highs (see [here](https://medium.com/p/9522fc0c67f5/)). Thus, the next major correction — the move down from ~$20,000 to ~$3,200 in late 2018 — is wave (4) (a three-wave correction) and the move up since then to above $13,000 is the beginning of wave (5). This wave count conforms to the Elliot Wave rules and guidelines (see [here](https://medium.com/p/7ecda8e92ee5/)), but it does have one drawback: compared to previous corrective waves of intermediate degree, wave (4) is massive. In fact, it lasted longer and nearly as waves ② and ④ which are higher degree (see [here](https://medium.com/p/8fe745374a0/)), and it reduced prices by ~84%.

However, as we saw in my [last post](https://medium.com/p/9522fc0c67f5/), all waves have been taking longer and longer to unfold, so perhaps wave (4)’s duration is not as dramatic as it seems. It is a correction of wave (3) after all, and wave (3) was massive too.

So, assuming we have labeled wave (4) correctly, is wave (5) unfolding as we would expect? So far, it is with two minor impulse waves (1 and 3) and two minor corrections (2 and 4), though it is too early to be sure of this count because these waves may be part of extensions. Regardless, a rise in price above the recent high over $13,000 would be a strong indication that our count is correct and the final push of cycle wave I is under way. A drop below the beginning of wave 2 (around $4,200) would invalidate the impulsive count of wave (5) because wave 4 cannot overlap wave 2 (see [here](https://medium.com/p/7ecda8e92ee5/)).This would indicate a much greater likelihood that our second scenario is playing out.

![](/assets/images/2019/m12/bitcoin-by-ross-from-the-20k-peak-to-today2.png)
