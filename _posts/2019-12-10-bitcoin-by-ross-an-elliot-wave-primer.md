---
title: "Bitcoin by Ross: An Elliot Wave Primer"
permalink: "/bitcoin-by-ross-an-elliot-wave-primer"
...
# [Bitcoin by Ross: An Elliot Wave Primer](https://medium.com/@RossUlbricht/bitcoin-by-ross-an-elliot-wave-primer-7ecda8e92ee5)
### By Ross Ulbricht
...
In these markets, the fractal is waves within waves within waves of optimism and pessimism, pushing prices up and down on every scale, from years and decades down to hours and seconds. A wave is jut a sustained movement in price, either up or down. The basic pattern is five waves up three waves down. (See Fig. 1)

![](/assets/images/2019/m12/bitcoin-by-ross-an-elliot-wave-primer1.png)
...
![](/assets/images/2019/m12/bitcoin-by-ross-an-elliot-wave-primer2.png)
...
In the [**next post**,](https://medium.com/p/4f4e86db7a4/) I describe the types of charts we’ll be using as we apply Elliot Wave to Bitcoin.
