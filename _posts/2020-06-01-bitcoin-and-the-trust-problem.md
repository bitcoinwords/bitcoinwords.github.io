...
excerpt: Karo Zagorus shares his thesis on Bitcoin and the Trust Problem. Posted June 4, 2020.
...
The progressive policies of Barack Obama have failed to improve the lives of rural Americans while it did improve the state of civil rights and liberties they were enjoying, especially in relation to LGBTQ+ rights[[7]](#_ftn7). Americans are still largely divided on critical policies such as Gun Rights, Environmental Protection and Abortions. (Bialik) 
...
Bitcoin as part of its original design, was the solution for the long-standing double spend[[11]](#_ftn11) problem that previous creators of digital currencies have unsuccessfully attempted to solve. (Nakamoto, Bitcoin: A Peer-to-Peer Electronic Cash System) 
...
Bitcoin, due to its digital nature, can be easily broken down to its smallest fraction of value, one bitcoin consists of 100 million satoshis[[12]](#_ftn12). In total, there will be a total of 2.100.000.000.000.000 satoshi ever in existence. (Rosenbaum) 
...
Since bitcoin is an engineered form of scarcity operating on the internet uninterrupted in the past 10 years, we must ask the question: How far this system is able to go? As claimed by a research done by Bayern Landesbank, a stock-to-flow[[14]](#_ftn14) ratio of over 100 is unprecedented in human history and such a monetary standard could have unpredictable effects on societies transacting with fiat currencies. (Andersch) 
...
The Bitcoin improvement Proposal of BIP38[[16]](#_ftn16) (passphrase protected paper wallets) and BIP39 (mnemonic code for generating deterministic keys) was a major milestone in this process of creating a truly sovereign form of money. 
...
The introduction of human readable words also makes it easier to store it, 24 words can be written down and stored safely or even memorized. The introduction of passphrase protected paper wallets also made it possible to introduce a 25th word[[17]](#_ftn17), that is the passphrase that can be anything. 
...
### A. “Just pull the plug out, and the problem is solved!”[[18]](#_ftn18)
...
Physical attacks during exchanges of bitcoins can also be a risk. There have been confirmed cases of attempted attacks against Bitcoiners who attempted to exchange their bitcoins for fiat currencies during in person meetups in public places.[[22]](#_ftn22) 
...
Partially signed Bitcoin transactions are a new isolated way of transaction generation and signing of the generated Bitcoin transaction. A computer software like Electrum[[23]](#_ftn23), Wasabi Wallet and mobile wallets like Samourai Wallet’s Sentinel application can generate transaction information by using an extended public key of a Bitcoin secret key that contains all the addresses (virtually everything, but only those necessarily that contain amounts of bitcoin) associated with a given secret key. When a transaction is generated, a data file is created that can be moved to another device, this is called as an unsigned transaction file. 
...
SatNode, which is operated by the Twitter user @notgrubles, had already the bot account suspended multiple times due to some users using the satellites to broadcast profanities targeting users, holders and developers of shitcoins[[24]](#_ftn24). 
...
The censorship resistant properties of the Tor[[25]](#_ftn25) protocol that anonymize its users is already being used to protect the users of Bitcoin wallets and Bitcoin nodes from third party, government snooping and interference. 
...
The term “#Reckless” was created, because as the network started operating people began to use it actively, although the Lightning Network is far from being finished or without critical bugs. Although stable and operational, it can already handle transactions. The Lightning Trust Chain (#LNTrustChain)[[38]](#_ftn38) was started by a pseudonymous Twitter user Hodlonaut who started passing around amounts of bitcoin to users who then passed it onto another, increasing their total amount over time. The point of the Lightning Trust Chain was to promote the use of the Lightning Network and show that it is functional and can handle transactions to places all over the world. The torch took 292 hops reaching the total amount limit of 4.29m satoshis, and as the last hop, it was symbolically donated to @btcven, a charity organization helping people in hyperinflation as it struck Venezuela. 
...
The fact that there have been no major 51% mining attack[[44]](#_ftn44) against other shitcoins, for longer periods of time, is just a temporary situation that might evolve in the future as Bitcoin’s mining increase and more people will be looking for ways to obtain scarce bitcoins. 
...
#### ii. Bitcoin Maximalism[[45]](#_ftn45)
...
The social space of Bitcoiners is remarkably interesting because of a prominent level of privacy extremism[[47]](#_ftn47) that is present within it. Many people who interact online often use pseudonyms or anonymous names that seek to protect their privacy and personal safety. To better understand these individuals and their capabilities, we should take a quick look at some of these differences between anonymous and pseudonymous Bitcoiners. 
...
Users soon have begun using hashtags on Twitter like “#WeAreAllHodlonaut” and “#CraigWrightIsAFraud” to voice their support and sympathy towards Hodlonaut. Bitcoiners and businesses, that are building onto the Bitcoin ecosystem, (like that of Media Outlets, Commercial Businesses, etc) have changed their avatars to that of Hodlonaut. Hodlonaut’s avatar is that of a cartoon astronaut space cat with different Bitcoin-oriented motives on its uniform that symbolize previous important milestones[[50]](#_ftn50) within the Bitcoin community’s life. 
...
Both groups are very casual, every day topics are shared in their group. Both groups are still available on Telegram and can be publicly accessed.[[51]](#_ftn51) 
