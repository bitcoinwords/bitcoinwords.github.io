...
# [Ten Mental Models Required To Understand Bitcoin](https://medium.com/@MiguelCuneta_21450/ten-mental-models-required-to-understand-bitcoin-9b239df42d81)
### By Miguel Cuneta
### Posted May 8, 2019
...
![](/assets/images/2019/m5/ten-mental-models-required-to-understand-bitcoin1.jpg)

*Image from Invertedpassion.com*

As part of an on-going**Tweetstorm Series***,*we showcase Twitter threads on the most interesting and controversial topics from all corners of the industry and publish them here in blog format for easier consumption and sharing beyond Twitter.

Today we explore twitter user [American Hodl’s](https://twitter.com/MericanHodl) tweetstorm about the ten mental models required to understand Bitcoin. Mental models are how we understand the world. They shape what we think and how we understand connections in everything around us. Mental models are how we simplify complexity, why we consider some things more relevant than others, and how we reason with the rest of reality.
...
![](/assets/images/2019/m5/ten-mental-models-required-to-understand-bitcoin2.jpg)

[American Hodl](https://twitter.com/MericanHodl)is a Bitcoiner since 2014 and a hodler of last resort. He suggests you read [this article](https://fs.blog/mental-models/) fs.blog/mental-models/) by Farnham street for a wider list of mental models.
...
# [Lightning Network Consensus Is a Marketplace and That's Okay](https://bitcoinmagazine.com/articles/op-ed-lightning-network-consensus-is-a-marketplace-and-thats-okay)
### By [John Carvalho](https://twitter.com/BitcoinErrorLog)
### Posted May 21, 2019
...
![](/assets/images/2019/m5/lightning-network-consensus-is-a-marketplace-and-thats-okay1.jpg)

Prefer us on Google (hidden on mobile)  [Prefer us on Google](https://www.google.com/preferences/source?q=bitcoinmagazine.com)  Apple App Store Button  [Download App](https://apps.apple.com/us/app/bitcoin-magazine-news/id6749723428)  Google Play Button  [![](/assets/images/2019/m5/lightning-network-consensus-is-a-marketplace-and-thats-okay2.webp)

 Download App](https://play.google.com/store/apps/details?id=com.anonymous.bmapp)

![](/assets/images/2019/m5/lightning-network-consensus-is-a-marketplace-and-thats-okay3.jpg)

#### **To Bitcoin or Not to Bitcoin**

During the “scaling debate” before the [SegWit2X user-activated soft fork](https://bitcoinmagazine.com/articles/these-international-bitcoin-communities-are-rejecting-segwit2x) (UASF), Bitcoin businesses were getting their first bitter taste of Bitcoin’s censorship resistance. They wanted change to be easier. They wanted their influence to be effective. They wanted to take shortcuts. Unfortunately for them, Bitcoin was created to resist control. Entities that seek to position themselves against Bitcoin are choosing a path of perpetual hypocrisy and frustration.

Those who follow me in interviews might be tired of hearing this, but each Bitcoin business has the choice of making Bitcoin its best friend or its worst enemy. The signers of the [New York Agreement](https://bitcoinmagazine.com/articles/dcgs-scaling-proposal-and-what-it-needs-succeed) chose to make Bitcoin their biggest problem and, to this day, most of them have only gotten worse in this regard.
...
Fast forward to the present and we have a new paradigm that has grown on top of Bitcoin.[The Lightning Network](https://bitcoinmagazine.com/articles/understanding-the-lightning-network-part-building-a-bidirectional-payment-channel-1464710791) anchors onto Bitcoin, providing a new way to transact. It is faster, less expensive, and capable of handling higher capacity. This is the first time we can truly use Bitcoin in a peer-to-peer fashion, instantly, within a much, much different protocol environment, an environment where you simply do not need to give trusted custody to receive centralized services.

But the former NYA SegWit2X players are mostly ignoring Lightning, with the most notable exception being [Bitfury and their Peach project](https://bitcoinmagazine.com/articles/can-i-trust-bitfurys-peach-lightning-with-my-data-maybe). More than 50 businesses supposedly wanted better Bitcoin scaling and supported forking Bitcoin. Now the great majority of those businesses aren’t helping with development, funding, products or services for the Lightning Network.
...
Familiarize yourself with the concept of **hybrid trust**: the temporary trust a business earns via reputation and their incentive to maintain it. This might sound like babble upon first reading it, but you can look at [Bitrefill’s Thor Turbo channels](https://www.bitrefill.com/thor-turbo-channels/) for a great example.
...
Let me let you in on a little secret. Objectively speaking, [**Bitrefill**](https://www.bitrefill.com/) is running the most economically relevant nodes on the Lightning Network and demonstrating the concept of a Lightning Service Provider (LSP) in its early stages by creatively leveraging hybrid trust to provide utility to real consumers.
...
Previous article[IRS Commissioner Makes Crypto Tax Clarity a Priority](https://bitcoinmagazine.com/business/irs-commissioner-makes-crypto-tax-clarity-priority)Next article[Tether Partly Backed by Bitcoin, Court Transcription Reveals](https://bitcoinmagazine.com/culture/tether-partly-backed-bitcoin-court-transcription-reveals)

RELATED ARTICLES    [TECHNICAL](https://bitcoinmagazine.com/technical)         [TECHNICAL](https://bitcoinmagazine.com/technical)         [TECHNICAL](https://bitcoinmagazine.com/technical)

##### LATEST NEWS

[Load more](https://bitcoinmagazine.com/articles/op-ed-lightning-network-consensus-is-a-marketplace-and-thats-okay#)

![](/assets/images/2019/m5/lightning-network-consensus-is-a-marketplace-and-thats-okay4.png)
