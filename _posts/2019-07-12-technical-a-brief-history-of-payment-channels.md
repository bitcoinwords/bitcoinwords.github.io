...
1.
You get some funds and create a transaction that pays to a 2-of-2 multisig between you and the bartender. You _**don't**_ broadcast this yet: you just sign it and get its txid.
2.
...
4.
_Now_ you broadcast the first transaction onchain. You and the bartender wait for it to be deeply confirmed, then you can start ordering.
