---
title: "October 2018 Journal"
permalink: "/cy18m10" 

header:
  teaser: /assets/images/covers/CY18M10-cover-1000.png
  overlay_image: /assets/images/covers/CY18M10-cover-header.png
  overlay_filter: 0.50
  actions:
...
[![October 2018 Journal Cover](/assets/images/covers/CY18M10-cover-150.png "October 2018 Journal Cover")](https://paywall.link/to/23930){: .align-left} *WORDS* is a monthly journal of Bitcoin commentary. For the uninitiated, getting up to speed on Bitcoin can seem daunting. Content is scattered across the internet, in some cases behind paywalls, and content has been lost forever. That’s why we made this journal, to preserve and further the understanding of Bitcoin.
...
I [often](https://twitter.com/TheStalwart/status/1049989106363707395) see Bitcoiners try to dispel criticism of its energy consumption by citing Bitcoin’s benefits as countervailing factors: “Electricity is expensive, but sound money is priceless!”

[Never works](https://twitter.com/bopinion/status/938852291452522496). No matter what social good is cited, it’s never enough.
...
> Because the challenge for Bitcoiners is to convince people that Bitcoin is a social good. So if you start your defense of the energy usage with the premise that Bitcoin is good, then you're just running back into the original problem.
>
> — Joe Weisenthal (@TheStalwart) [October 10, 2018](https://twitter.com/TheStalwart/status/1050004059539816449?ref_src=twsrc%5Etfw)
...
No, we refuse to normalize your [communist](https://twitter.com/EricHolthaus/status/1049339997827084295) anti-freedom orthodoxy.

Once we disabuse ourselves of Nocoiner fallacies, it becomes very easy to counter concern trolls. See:

**FUD: Bitcoin uses more electricity than all of [Denmark](https://motherboard.vice.com/en_us/article/aek3za/bitcoin-could-consume-as-much-electricity-as-denmark-by-2020)!**
...
![](/assets/images/2018/m10/reject-nocoiner-orthodoxy1.jpg)
...
> kinda like how Motel 6’s slogan is “We’ll leave the light on for you” — No one ever says “That’s so wasteful!” We think, oh good, how convenient.
>
> — Elaine 🦉🇮🇨 (@eiaine) [October 10, 2018](https://twitter.com/eiaine/status/1050133363837657088?ref_src=twsrc%5Etfw)

**FUD: Bitcoin can be used to bypass [sanctions](https://www.foxnews.com/tech/iran-north-korea-and-venezuela-turning-to-cryptocurrency-to-bypass-us-sanctions-experts-warn)!**
...
**FUD: Bitcoin is used for [tax evasion](https://www.bloomberg.com/news/articles/2018-02-08/irs-cops-scouring-crypto-accounts-to-build-tax-evasion-cases)!**
 ...
 **₿:** Indeed! Money flows to where it’s treated best. Bitcoin is doing [God’s work](https://dealbook.nytimes.com/2009/11/09/goldman-chief-says-he-is-just-doing-gods-work/).
...
**FUD: Bitcoin is being used by [neo-Nazis](https://www.theguardian.com/commentisfree/2018/jan/24/bitcoin-currency-far-right-neo-nazis-cryptocurrencies)!**
 **₿:** Wonderful! I’m so glad we finally have a payment system that is impervious to bullying from the shakedown racket known as the [**SPLC**](https://www.philanthropyroundtable.org/philanthropy-magazine/article/spring-2017-briefly-noted).

**FUD: [North Korea](https://ftalphaville.ft.com/2018/01/18/2197837/a-theory-about-the-recent-crypto-price-plunge/) is mining Bitcoin!**
 **₿:** Fantastic! This is so great. China’s concentration of mining power has long been one of the biggest threats to Bitcoin, and the entry of state-sponsored competitors would enhance miner decentralization. [Jurisdictional diversity](https://elaineou.com/2017/09/16/diversity-and-inclusion-for-bitcoin/) is Bitcoin’s greatest strength!

**FUD: Bitcoin has a high [Gini coefficient](https://bitsonline.com/bitcoin-north-korea-gini-coefficient-nouriel-roubini/) and massive wealth inequality!**
 **₿:** Yes! [Economic inequality](http://www.paulgraham.com/ineq.html) is something that happens when wealth is created, and a permissionless financial system democratizes wealth creation. Even though socioeconomic mobility has gone to shit in this country, Bitcoin is still the land of opportunity!

**FUD: Bitcoin is being used to fund [Terrorism](https://www.coindesk.com/u-s-think-tank-finds-rising-bitcoin-price-linked-terrorist-interest/)!**
 **₿:** This one might be of legitimate concern. There’s a theory that Bitcoin was created by the CIA to fund extremist groups in the Middle East and effect a regime change in Syria and Iran. Well, the second part of that sentence isn’t just theory — [the CIA is financing terrorism](https://www.nytimes.com/2017/08/02/world/middleeast/cia-syria-rebel-arm-train-trump.html) regardless of Bitcoin. Let’s abolish the CIA.

***

# [Why isn’t Bitcoin banned everywhere?](https://hackernoon.com/why-isnt-bitcoin-banned-everywhere-32a2caec90)
### By Haseeb Qureshi
...
There’s been a [lot](https://www.americanbanker.com/opinion/is-congress-really-ready-to-take-on-crypto?ref=hackernoon.com) [of](https://www.investopedia.com/news/japans-fsa-bans-private-cryptocurrencies/?ref=hackernoon.com) [tumult](https://www.chainbits.com/news/us-senators-want-stronger-sanctions-on-venezuelas-crypto-petro/?ref=hackernoon.com) on the regulatory front lately. But amidst the frenetic crypto news cycle, it’s easy to lose sight of how weird it is that Bitcoin is legal at all. Obviously it’s good that it is — but we should be surprised this happened!
...
Perhaps governments are pattern-matching blockchains with the Internet. A wait-and-see approach to internet regulation was clearly instrumental to its flourishing, and perhaps governments intend to do the same here. But governments have also fought tooth and nail against end-to-end encryption, P2P filesharing, privacy technologies like Tor, and financial networks that enable tax evasion (see [e-gold](https://en.wikipedia.org/wiki/E-gold?ref=hackernoon.com) and global financial surveillance policies like [FATCA](https://en.wikipedia.org/wiki/Foreign_Account_Tax_Compliance_Act?ref=hackernoon.com)). If Bitcoin threatens the power of financial surveillance, then it would be considered far more dangerous than any of these prior technologies.
...
How is this done? It starts with the fiat onramps, where an exchange collects information on you through their KYC process. This information that is often shared with other exchanges when investigating suspicious activity. Even once take your Bitcoin onto the mainnet, your activity can still be tracked. [Heuristics and clustering analysis](https://bitfury.com/content/downloads/clustering_whitepaper.pdf?ref=hackernoon.com) are often used to identify exchanges, mixers, and other common blockchain services you use. [Supernodes](https://www.coindesk.com/chainalysis-ceo-denies-launching-sybil-attack-on-bitcoin-network/?ref=hackernoon.com) connect to large swathes of the Bitcoin network and correlate transactions with their originating IPs. Even with meticulous opsec and address rotation (which most people don’t do), if you ever want to turn your Bitcoin back into fiat, that offramp is just as highly regulated. Often you will be turned away if your Bitcoin appears tainted by signs of illegal activity.

This is more than hypothetical. Exchanges have significant insight into the flows of Bitcoin — enough to successfully deter hacks, stolen funds, and regularly file [suspicious activity reports](https://en.wikipedia.org/wiki/Suspicious_activity_report?ref=hackernoon.com) (as all US exchanges are required to). We saw this with the [Mueller Probe](https://blog.cotten.io/bitcoin-money-laundering-and-muellers-12-e2fa91097e12?ref=hackernoon.com) and with analysis of the [Mt. Gox hack](https://www.youtube.com/watch?v=l70iRcSxqzo&ref=hackernoon.com). Companies like Chainalysis provide surveillance services to law enforcement and various three-letter agencies, [reportedly earning more than $5.7M in 2018 via government contracts](https://diar.co/volume-2-issue-38/?ref=hackernoon.com).

![](/assets/images/2018/m10/why-isnt-bitcoin-banned-everywhere3.jpg)
...
Bitcoin is unlikely to become a global currency for several reasons, each of which could be an essay on their own. But in short: Bitcoin has [too high latency, too low throughput](https://en.wikipedia.org/wiki/Bitcoin_scalability_problem?ref=hackernoon.com), and its divisibility is too low [due to the rising dust limit](https://www.reddit.com/r/Bitcoin/comments/2unzen/what_is_bitcoins_dust_limit_precisely/?ref=hackernoon.com) (currently about 3c USD for non-Segwit transactions). Furthermore, even if second-layer scaling technologies like the Lightning Network prove successful, Bitcoin’s deflationary monetary policy makes it a [poor medium of exchange](https://www.economist.com/free-exchange/2014/04/03/bitcoins-deflation-problem?ref=hackernoon.com).
...
So Bitcoin is not suited to be a global currency. But Bitcoin can still succeed! As Nic Carter (no affiliation with the Backstreet Boys) documents, Bitcoin has iterated its way into a [vision of “digital gold.”](https://medium.com/@nic__carter/visions-of-bitcoin-4b7b7cbcd24c?ref=hackernoon.com) Turns out, sovereigns are pretty okay with this.

![](/assets/images/2018/m10/why-isnt-bitcoin-banned-everywhere4.jpg)
...
![](/assets/images/2018/m10/why-isnt-bitcoin-banned-everywhere5.jpg)
