...
[Donate & Download the January 2018 Journal PDF](https://paywall.link/to/cy18m1){: .btn .btn--primary}
...
# [A Bitcoin ETF is a Good Way to Ruin Bitcoin](https://elaineou.com/2018/01/09/a-bitcoin-etf-is-a-good-way-to-ruin-bitcoin/)
### By [Elaine Ou](https://twitter.com/elaineou)
### Posted January 9, 2018

I don’t understand why people want a [Bitcoin ETF](https://twitter.com/EricBalchunas/status/950353153022623744).

I mean, I get that retail investors want exposure to Bitcoin. Who wouldn’t? Bitcoin has outperformed every asset class in the last decade, with an annualized return of [infinity percent](https://twitter.com/eiaine/status/843899676260679681)!
...
![](/assets/images/2018/m1/a-bitcoin-etf-is-a-good-way-to-ruin-bitcoin1.png)
...
![](/assets/images/2018/m1/a-bitcoin-etf-is-a-good-way-to-ruin-bitcoin2.jpg)
...
![](/assets/images/2018/m1/a-bitcoin-etf-is-a-good-way-to-ruin-bitcoin3.png)

**One more:** In 1669, German alchemist [Hennig Brand](https://www.npr.org/sections/health-shots/2016/02/02/465188104/phosphorus-starts-with-pee-in-this-tale-of-scientific-serendipity) was examining his own urine when he discovered the elemental form of Phosphorous[<sup>1</sup>](https://elaineou.com/2018/01/09/a-bitcoin-etf-is-a-good-way-to-ruin-bitcoin/#btcft1). As it turns out, phosphorous is crucial to fertilizer production. Speculators took to hoarding phosphate rock and bodily fluids, fertilizer became too expensive for agricultural use, and civilization fell into a [Malthusian trap](https://unenumerated.blogspot.com/2016/02/two-malthusian-scares.html), where we live on the brink of starvation today.

None of those things happened. It doesn’t make sense to hoard a commodity because humans always figure out how to make things cheaper. No matter how often alarmists scream about [Peak Oil](https://en.wikipedia.org/wiki/Peak_oil) and [Peak Copper](https://en.wikipedia.org/wiki/Peak_copper) and [Peak Phosphorous](https://en.wikipedia.org/wiki/Peak_phosphorus) and [Peak Coal](https://en.wikipedia.org/wiki/Peak_coal) and [Peak Water](https://en.wikipedia.org/wiki/Peak_water) and [Peak Gold](https://en.wikipedia.org/wiki/Peak_gold), commodity prices have stayed constant in the [long run](https://www.economist.com/blogs/freeexchange/2013/03/resource-prices). To believe otherwise is to ignore thousands of years of human progress.

Bitcoin has only one unassailable use case: It pays transaction fees on the Bitcoin network. For everything else — whether remittances, micropayments, or means of cyber-extortion – there exists a substitute. What do Bitcoin ETF buyers think they’re getting here? A cryptocurrency is not a business – software contributors aren’t employees, and they’re certainly not working to maximize returns for investors. In fact, they’re working towards the opposite: Recent developments enable users to create [more transactions](https://en.bitcoin.it/wiki/Lightning_Network) while paying lower fees, and do Bitcoin things [without even using Bitcoin](https://en.bitcoin.it/wiki/Atomic_cross-chain_trading).
...
**1.**  Brand was looking for gold in the yellow liquid. Is it just me or does this seem like a particularly [German](https://elaineou.com/2016/11/15/what-is-up-with-germans-and-scheise/) thing to do?
